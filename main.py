...
parser.add_argument('--text_pretrained_model', default='bert-base-chinese', help='文本分析模型', type=str)
parser.add_argument('--fuse_model_type', default='METAPHOR', help='融合模型类别', type=str)
...
if config.fuse_model_type == 'METAPHOR' or config.fuse_model_type =='HiddenStateTransformerEncoder':
